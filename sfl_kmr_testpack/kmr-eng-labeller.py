...
def prepare_data():
	...
	with open('kmr-embeddings.vec', 'r', encoding = 'utf-8') as file:
		f = file.readlines()

	with open('kmr-int2syntax.json', 'r', encoding = 'utf-8') as jsonfile:
		s = jsonfile.read()
...
def replace_useless_tags(checked_sequences):
	with open('kmr-tags.txt', 'r', encoding = 'utf-8') as file:
